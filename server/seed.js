...
export function seed() {
  ...
  const insertCat = db.prepare('INSERT INTO categories (name, slug, description, image, enabled, sort_order) VALUES (?, ?, ?, ?, 1, ?)');
  const catIds = {};
  categories.forEach((c, idx) => {
    catIds[c.slug] = insertCat.run(c.name, c.slug, c.description, c.image, idx + 1).lastInsertRowid;
  });

  const products = [
    {
      name: 'زي الشرطي الصغير',
      slug: 'mini-police-costume',
      ...
      price: 4200, old_price: 5000, stock: 30,
      category: 'kids-costumes', age: '3 - 8 سنوات',
      is_new: 1, is_bestseller: 1, is_featured: 1,
      image: '/images/prod-police.svg',
    ...
    },
    {
      ...
      price: 4600, old_price: null, stock: 25,
      category: 'kids-costumes', age: '3 - 9 سنوات',
      is_new: 0, is_bestseller: 1, is_featured: 1,
      image: '/images/prod-superhero.svg',
    ...
    {
      name: 'حقيبة الأبطال الصغار',
      slug: 'little-heroes-bag',
      ...
      price: 2800, old_price: 3400, stock: 40,
      category: 'kids-accessories', age: '3 - 10 سنوات',
      is_new: 1, is_bestseller: 0, is_featured: 0,
      image: '/images/prod-bag.svg',
    ...
    {
      name: 'مجموعة الرسم والإبداع',
      slug: 'art-and-creativity-set',
      ...
      price: 3200, old_price: 3900, stock: 50,
      category: 'creativity-crafts', age: '3 - 12 سنة',
      is_new: 0, is_bestseller: 1, is_featured: 1,
      image: '/images/prod-crafts.svg',
    ...
    },
    {
      ...
      price: 3800, old_price: null, stock: 20,
      category: 'educational', age: '2 - 6 سنوات',
      is_new: 1, is_bestseller: 0, is_featured: 1,
      image: '/images/prod-educational.svg',
    ...
    },
    {
      ...
      price: 3600, old_price: 4200, stock: 35,
      category: 'kids-toys', age: '3 - 10 سنوات',
      is_new: 0, is_bestseller: 1, is_featured: 1,
      image: '/images/prod-blocks.svg',
    ...
    {
      name: 'بدلة رجل الإطفاء الصغير',
      slug: 'mini-fireman-costume',
    ...
    },
    {
      ...
      price: 5200, old_price: 6200, stock: 12,
      category: 'kids-gifts', age: '3 - 10 سنوات',
      is_new: 0, is_bestseller: 0, is_featured: 1,
      image: '/images/prod-gift.svg',
    ...
    {
      name: 'سبورة الرسم السحرية',
      slug: 'magic-drawing-board',
      ...
      price: 2400, old_price: 2900, stock: 45,
      category: 'creativity-crafts', age: '3 - 10 سنوات',
      is_new: 1, is_bestseller: 0, is_featured: 0,
      image: '/images/prod-board.svg',
    ...
    },
    {
      ...
      price: 4000, old_price: 4700, stock: 22,
      category: 'kids-toys', age: '3 - 8 سنوات',
      is_new: 0, is_bestseller: 0, is_featured: 0,
      image: '/images/prod-kitchen.svg',
  ...
  const insertProduct = db.prepare(`
    ...
    VALUES (@name, @slug, @short, @description, @price, @old_price, @stock, @categoryId,
      @age, @is_new, @is_bestseller, @is_featured, 1, @image, @keywords, @specs, @features)
  `);

  const productIds = {};
  for (const p of products) {
    const info = insertProduct.run({
      name: p.name, slug: p.slug, short: p.short, description: p.description,
      price: p.price, old_price: p.old_price, stock: p.stock,
      categoryId: catIds[p.category], age: p.age,
      is_new: p.is_new, is_bestseller: p.is_bestseller, is_featured: p.is_featured,
      image: p.image, keywords: p.keywords, specs: p.specs, features: p.features
    });
    productIds[p.slug] = info.lastInsertRowid;
    db.prepare('INSERT INTO product_images (product_id, image, sort_order) VALUES (?, ?, 0)')
      .run(info.lastInsertRowid, p.image);
  }

  // Sample approved reviews (these are clearly sample/demo - admin can edit/approve)
  const reviews = [
  ...
  const insertReview = db.prepare('INSERT INTO reviews (customer_name, rating, comment, product_id, verified, approved) VALUES (?, ?, ?, ?, ?, 1)');
  for (const r of reviews) {
    insertReview.run(r.name, r.rating, r.comment, productIds[r.product], r.verified);
  }
