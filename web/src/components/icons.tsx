...
export function WhatsAppIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12.04 2a9.9 9.9 0 0 0-8.4 15.3L2 22l4.85-1.6A9.9 9.9 0 1 0 12.04 2zm5.86 14.06c-.25.7-1.44 1.33-2 1.38-.53.05-1.2.24-4.03-.84-3.4-1.31-5.55-4.73-5.72-4.95-.16-.22-1.36-1.81-1.36-3.45 0-1.64.86-2.45 1.17-2.78.3-.34.66-.42.88-.42.22 0 .44 0 .63.01.2.01.47-.08.74.57.27.66.93 2.26 1.01 2.43.08.16.14.36.03.58-.1.22-.16.35-.31.54-.15.19-.32.43-.46.58-.15.15-.31.31-.13.61.17.3.77 1.27 1.66 2.06 1.14 1.01 2.1 1.32 2.4 1.47.3.15.47.13.64-.08.17-.21.74-.86.94-1.16.2-.3.4-.25.67-.15.27.1 1.72.81 2.02.96.3.15.5.22.57.34.07.12.07.72-.18 1.42z" />
    </svg>
  );
}
...
export function StarIcon({ className, size = 18, filled = true }: IconProps & { filled?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.5" className={className} aria-hidden="true">
